//-------------------signin.jsx--[before add user state]--------------
...
//======================signin - conditional rendearing ,check user ase ki na, singout-----------
import { Link } from "react-router";
import MyContainer from "../components/MyContainer";
import { useState } from "react";
import { FaEye } from "react-icons/fa";
            ...
            {user ? (
              <div className="text-center space-y-3 ">
                <img
                  ...
                  src={user?.photoURL || "https://via.placeholder.com/888"}
                  alt=""
                />
...
//---------------signup--------------before added user state
